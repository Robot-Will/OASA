...
for i in range(len(TestLinearFormula.formulas)):
    setattr(
        TestLinearFormula, "testformula" + str(i + 1), create_test(i, "_testformula")
    )
...
for i in range(len(TestSubstructure.formulas)):
    setattr(
        TestSubstructure, "testformula" + str(i + 1), create_test(i, "_testformula")
    )
...
for i in range(len(TestSMILESReading.formulas)):
    setattr(
        TestSMILESReading, "testformula" + str(i + 1), create_test(i, "_testformula")
    )
